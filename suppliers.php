                ...
                <tbody>
                    <?php
                        ...
                        if (isset($_GET['search'])) {
                            ...
                            $query = "SELECT * FROM suppliers WHERE CONCAT(supplier_name, contact) LIKE '%$filtervalues%'";
                        } else {
                            ...
                            foreach ($result as $supplier) { ?>
                                <tr style="text-align: center;">
                                    ...
                                    <td  style="display:flex;">
                                        <a href="supdelete.php?supplier_id=<?php echo $supplier['supplier_id']; ?>" 
                                            onclick="return confirm('Are you sure you want to delete this supplier?')" 
                                            class="btn btn-outline-danger">Delete</a>
                                        <a href="supupdateform.php?supplier_id=<?php echo $supplier['supplier_id']; ?>" 
