...
if (isset($_POST['submit'])) {
    ...
    if (empty($supplier_name) || empty($contact)) {
        echo "<script>alert('Supplier name and contact cannot be empty! Please enter a value.'); window.location.href='add_suppliers.php';</script>";
    } else {

        $insertQuery = "INSERT INTO `suppliers` (`supplier_name`, `contact`) VALUES (?, ?)";
                ...
                <div class="col-8">
                    <div class="container">
                        ...
                        <form action="" method="POST" class="form">
                            ...
                            <button type="submit" name="submit" class="login-button">Add Supplier</button>
                        </form>
